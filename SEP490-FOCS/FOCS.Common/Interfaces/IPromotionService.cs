...
namespace FOCS.Common.Interfaces
{
    ...
    {
        Task<PromotionDTO> CreatePromotionAsync(PromotionDTO dto, string storeId, string userId);
        Task<PromotionDTO> GetPromotionAsync(Guid promotionId, string userId);
        Task<PagedResult<PromotionDTO>> GetPromotionsByStoreAsync(UrlQueryParameters query, string storeIdStr, string userId);
        Task<bool> UpdatePromotionAsync(Guid promotionId, PromotionDTO dto, string storeIdStr, string userId);
