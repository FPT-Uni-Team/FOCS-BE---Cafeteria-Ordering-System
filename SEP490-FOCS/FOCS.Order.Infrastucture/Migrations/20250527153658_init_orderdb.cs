        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CustomTaxRate = table.Column<double>(type: "float", nullable: true),
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MenuCategories_Stores_StoreId",
                        column: x => x.StoreId,
                        principalTable: "Stores",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    OrderWrapStatus = table.Column<int>(type: "int", nullable: false),
                    Quantity = table.Column<int>(type: "int", nullable: false),
                    DisplayOrderWrap = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    StoreId = table.Column<Guid>(type: "uniqueidentifier", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_OrderWraps", x => x.Id);
                    table.ForeignKey(
                        name: "FK_OrderWraps_Stores_StoreId",
                        column: x => x.StoreId,
                        principalTable: "Stores",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PaymentConfig = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SubTotalAmout = table.Column<double>(type: "float", nullable: false),
            ...
            migrationBuilder.CreateTable(
                name: "PromotionItemConditions",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    PromotionId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    BuyItemId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    BuyQuantity = table.Column<int>(type: "int", nullable: false),
                    GetItemId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    GetQuantity = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_PromotionItemConditions", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PromotionItemConditions_MenuItems_BuyItemId",
                        column: x => x.BuyItemId,
                        principalTable: "MenuItems",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_PromotionItemConditions_MenuItems_GetItemId",
                        column: x => x.GetItemId,
                        principalTable: "MenuItems",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_PromotionItemConditions_Promotions_PromotionId",
                        column: x => x.PromotionId,
                        principalTable: "Promotions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PrepPerTime = table.Column<int>(type: "int", nullable: false),
                    QuantityPerTime = table.Column<int>(type: "int", nullable: false),
                    IsAvailable = table.Column<bool>(type: "bit", nullable: false),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MenuCategories_StoreId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OrderWraps_StoreId",
                table: "OrderWraps",
                column: "StoreId");

            migrationBuilder.CreateIndex(
                name: "IX_PromotionItemConditions_BuyItemId",
                table: "PromotionItemConditions",
                column: "BuyItemId");

            migrationBuilder.CreateIndex(
                name: "IX_PromotionItemConditions_GetItemId",
                table: "PromotionItemConditions",
                column: "GetItemId");

            migrationBuilder.CreateIndex(
                name: "IX_PromotionItemConditions_PromotionId",
                table: "PromotionItemConditions",
                column: "PromotionId");
